...
if ($conn->query($sql) ==TRUE) {
    echo '<h1  style="text-align: center;">User blocked sucessfully</h1>';
} else {
...
<div>
 <div data-v-309ccc10="" class="recharge">
        ...
        <form action="" id="adminverify" method="POST" class="form-signup">
            <h2 style="padding:10px;">Enter the Username  to Block USER</h2>
            ...
            <div data-v-309ccc10="" class="input_box_btn"><button data-v-309ccc10=""
                    class="login_btn ripple">Block USER</button></div>
                    </form>
