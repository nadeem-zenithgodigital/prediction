...
if($sum['total']==""){
    ...
    $dataRow = $dataRow."
           <tr class='user' ><td >$row2[1]</td><td>$bonus</td><td>$first</td><td>$row2[5]</td></tr>";
...
<div>
 <div data-v-309ccc10="" class="recharge">
        ...
        <form action="" id="adminverify" method="POST" class="form-signup">
            <h2 style="padding:10px;">Enter the Username to Get Invite Details</h2>
            ...
            <div data-v-309ccc10="" class="input_box_btn"><button data-v-309ccc10=""
                    class="login_btn ripple">Get Details</button></div>
                    </form>
