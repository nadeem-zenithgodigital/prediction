...
$query11 = "SELECT username FROM `users` WHERE username='$username'";
...
$sql = "INSERT INTO users (username,password,usercode) VALUES('$username','$newpassword','$user_code')";

$conn->query($sql);
if ($conn->query($sql) === TRUE) {
    echo '<h1  style="text-align: center;">User Created sucessfully</h1>';
} else {
    echo '<h1  style="text-align: center;" >User Created sucessfully</h1>';
}
...
<div>
 <div data-v-309ccc10="" class="recharge">
        ...
        <form action="" id="adminverify" method="POST" class="form-signup">
            <h2 style="padding:10px;">Enter the Username and Password to ADD USER</h2>
            ...
            <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    ...
                    data-v-309ccc10="" class="tips_span">Password</span></div>
            <div data-v-309ccc10="" class="input_box_btn"><button data-v-309ccc10=""
                    class="login_btn ripple">ADD USER</button></div>
                    </form>
