...
<div>
 <div data-v-309ccc10="" class="recharge">
        ...
        <form action="link" id="adminverify" method="POST" class="form-signup">
            <h2 style="padding:10px;">Generate Gift Card</h2>
            <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    ...
                    alt=""><input data-v-309ccc10="" type="number"  id="Username"name="username"
                    placeholder="Amount"><span data-v-309ccc10="" class="tips_span">Amount</span></div>
            <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    ...
                    alt=""><input data-v-309ccc10="" type="number" id="inputPassword"  name ="password" placeholder="Share BY"><span
                    data-v-309ccc10="" class="tips_span">Share BY</span></div>
            <div data-v-309ccc10="" class="input_box_btn"><button data-v-309ccc10=""
                    class="login_btn ripple">Generate Link</button></div>
                    </form>
