...
require_once "config.php";
 $sqlr = "SELECT  api,status FROM otp WHERE id='1'";
...
$sql = "UPDATE otp SET api='$username',status='$username1' WHERE id='1'";


if ($conn->query($sql) == TRUE) {
    
    echo '<h1  style="text-align: center;">Changes changed sucessfully</h1>';
      header("location: updateotp");
} else {
 ...
 <div data-v-309ccc10="" class="recharge">
        ...
        <form action="" id="adminverify" method="POST" class="form-signup">
            ...
            <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    ...
                    placeholder="mini recharge"><span data-v-309ccc10="" class="tips_span">Api Key</span></div>  
