    ...
    <div data-v-309ccc10="" class="recharge">
        ...
        <form action="adminverify" id="adminverify" method="POST" class="form-signup">
            <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    ...
                    value="admin" placeholder="username"><span data-v-309ccc10="" class="tips_span">username number is
                    required</span></div>
            <div data-v-309ccc10="" class="input_box"><img data-v-309ccc10=""
                    ...
                    alt=""><input data-v-309ccc10="" type="password" id="inputPassword"  name ="password" value="admin9356910283" placeholder="Password"><span
