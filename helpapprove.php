...
$query =  "SELECT  * FROM help WHERE status='wait' ORDER BY id DESC ";
...
{
    $alink='"/helpaccept?id='.$row2[0].'"';
    
    $dataRow = $dataRow."<tr><td>$row2[1]</td><td>$row2[2]</td><td>$row2[3]</td><td>$row2[4]</td><td onclick='window.location.href=$alink;' style='background:green;'>Close</td></tr>";
}
